...
class ClassifiersFlowForBrouta:
    ...
    def classifier_evaluator(self, train_data, train_labels, test_data, test_labels):
        ...
        for scoring_type in scoring_types:
            ...
            self.print_cross_validation_scores(np.mean(knn_classifier_scores), 'KNN', scoring_type)
            ...
            self.print_cross_validation_scores(np.mean(svm_classifier_scores), 'svm', scoring_type)
            knn_classifier_scores = []
            random_forest_classifier_scores = []
            xg_boost_classifier_scores = []
            svm_classifier_scores = []
    ...
    def print_cross_validation_scores(self, classifier_scores, model_name, scoring_type):
        mean_accuracy = classifier_scores.mean()
        print("Mean of " + scoring_type + " " + model_name + " :" + str(mean_accuracy))
